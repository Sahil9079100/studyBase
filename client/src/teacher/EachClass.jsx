        ...
        <div className="p-4">
            ...
            <div className='flex flex-col gap-2 justify-center items-center p-2'>
                {ClassStudentData.subjects.map((elem, idx) => (
                    <div onClick={() => { if (elem.teacherId == teacherData.name) { navi(`/teacher/${teacherData._id}/classes/${classnum}/${elem.name}`) } }} key={idx} className='bg-blue-800/50 p-3 rounded-lg flex items-center justify-between  w-full'>
